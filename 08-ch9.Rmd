...
## Canonical NP-Complete Graph Problems
...
\[\begin{array}{ccc}
\text{Original Graph } G & & \text{Complement Graph } \overline{G} \\[6pt]
\text{Independent Set } (I) & \Longleftrightarrow & \text{Clique } (C) 
\end{array}\]

\[\textbf{Complement Set} \]
\[\begin{array}{ccc}
\text{Independent Set } (I) & \Longleftrightarrow & \text{Vertex Cover } (V \setminus I)
\end{array}\]




```{theorem,name="Structural Duality"}
...
### Hamiltonian Cycle vs. Eulerian Tour
